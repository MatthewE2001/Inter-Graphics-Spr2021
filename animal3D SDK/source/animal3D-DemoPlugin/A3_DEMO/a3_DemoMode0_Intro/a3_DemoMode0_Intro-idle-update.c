...
void a3intro_update_scene(a3_DemoState* demoState, a3_DemoMode0_Intro* demoMode, a3f64 const dt)
{
	...
	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_capsule, (a3ui32)(demoMode->obj_ground - demoMode->obj_capsule),
		2, demoState->updateAnimation);
	a3demo_updateSceneObject(demoMode->obj_capsule, 0);
	a3demo_updateSceneObjectStack(demoMode->obj_capsule, projector);

	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_cone, (a3ui32)(demoMode->obj_ground - demoMode->obj_cone), 
		2, demoState->updateAnimation);
	a3demo_updateSceneObject(demoMode->obj_cone, 0);
	a3demo_updateSceneObjectStack(demoMode->obj_cone, projector);

	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_cylinder, (a3ui32)(demoMode->obj_ground - demoMode->obj_cylinder), 
		2, demoState->updateAnimation);
	a3demo_updateSceneObject(demoMode->obj_cylinder, 0);
	a3demo_updateSceneObjectStack(demoMode->obj_cylinder, projector);

	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_teapot, (a3ui32)(demoMode->obj_ground - demoMode->obj_teapot),
		2, demoState->updateAnimation);
	a3demo_updateSceneObject(demoMode->obj_teapot, 0);
	a3demo_updateSceneObjectStack(demoMode->obj_teapot, projector);

	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_torus, (a3ui32)(demoMode->obj_ground - demoMode->obj_torus),
		2, demoState->updateAnimation);
